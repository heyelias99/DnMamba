...
if __name__ == "__main__":
    ...
    parser.add_argument('--saved_path', type=str, default='.//10_npy_img/')
    parser.add_argument('--save_path', type=str, default='.//save_10_DNM')
    # parser.add_argument('--test_patient', type=tuple, default=('L056','L004','L006','L019'))
    ...
    parser.add_argument('--trunc_max', type=float, default=240)
    ...
    parser.add_argument('--test_iters', type=int, default=2000)
